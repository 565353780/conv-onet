...
from conv_onet.Method.common import coordinate2index, normalize_coordinate, normalize_3d_coordinate
...
class LocalVoxelEncoder(nn.Module):
    ...
    def generate_grid_features(self, p, c):
        ...
        fea_grid = fea_grid.reshape(p.size(0), self.c_dim, self.reso_grid,
